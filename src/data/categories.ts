    ...
    subcategories: [
      {
        ...
        criteria: [
          { label: 'Sporting Performance & Achievement', weight: 30 },
          { label: 'Contribution to Kambata Football', weight: 25 },
          { label: 'Youth Inspiration & Mentorship', weight: 20 },
          { label: 'Professionalism & Discipline', weight: 15 },
          { label: 'Community Representation & Goodwill', weight: 10 },
        ],
      },
      {
      ...
      },
      {
        ...
        criteria: [
          { label: 'Community Health & Fitness Impact', weight: 25 },
          { label: 'Achievement & Professional Excellence', weight: 25 },
          { label: 'Kambata Community Goodwill', weight: 20 },
          { label: 'Youth Empowerment', weight: 15 },
          { label: 'Consistency & Professionalism', weight: 15 },
        ],
      },
    ],
  },
